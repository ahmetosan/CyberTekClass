...
class Main_yedek {
    public static void main(String[] args) {
        ...
        if (product.equals(price1<100) || product.equals(price2<100)) {
            System.out.println("Sorry, not enough funds on your gift card!");
        }
        else if (product.contentEquals("Smartphone") && price1 <= 100) {
            System.out.println("Thank you for your purchase!");
            System.out.println("Your current balance is: " + (giftCard - price1) + "$");
        }
        else if (product.contentEquals("Laptop") && price2 <= 100) {
            System.out.println("Thank you for your purchase!");
            System.out.println("Your current balance is: " + (giftCard - price2) + "$");
